    ...
    <div class="container">
        ...
        <table>
            ...
            ORDER BY patient.DATE DESC;";
                $totalPatientsSql = "SELECT COUNT(*) AS totalPatients FROM db_sm3101.patient where patient.studid > 0";
                $result = mysqli_query($conn, $sql);
            }
