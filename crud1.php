...
<body>
    <div class="container">
        <h2>Employee File Editor</h2>

        <!-- Button Container on the Left -->
        <div class="button-container">
            <a href="logform1.php" class="button">Back</a>
            <a href="home1.php" class="button">Back to Home</a>
            
            <a href="crud1.php" class="button">Reload</a>
        </div>
        ...
        <table>
            ...
            LEFT JOIN tbempinfo ON tbincharge.empid = tbempinfo.empid 
            LEFT JOIN tbstudinfo ON patient.studid = tbstudinfo.studid 
            WHERE patient.studid = 0
            ORDER BY patient.DATE DESC";
                $totalPatientsSql = "SELECT COUNT(*) AS totalPatients FROM db_sm3101.patient where patient.empid > 0";
                $result = mysqli_query($conn, $sql);
            }
             ...
             while($row = mysqli_fetch_assoc($result)){
                ...
                echo " <td class='text-center' > <a href='edit1.php?update&ID={$ID}' class='btn btn-secondary'><i class='bi bi-pencil'></i> EDIT</a> </td>";
